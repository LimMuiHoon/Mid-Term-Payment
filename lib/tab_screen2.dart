...
import 'package:my_barter/newbarter.dart';
...
class _TabScreen2State extends State<TabScreen2> {
                                ...
                                Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        image: DecorationImage(
                                            fit: BoxFit.fill,
                                            image: NetworkImage(
                                                "https://tradebarterflutter.com/mytradebarter(user)%20/images/${data[index]['barterimage']}.jpg")))),
                                Expanded(
                                  child: Container(
                                    child: Column(
                                      children: <Widget>[
  ...
  Future<String> makeRequest() async {
    String urlLoadBarter =
        "https://tradebarterflutter.com/mytradebarter(user)%20/php/load_barter_user.php";
  ...
  Future<String> deleteRequest(String barterid) async {
    String urlLoadBarter =
        "https://tradebarterflutter.com/mytradebarter(user)%20/php/delete_barter.php";
    ProgressDialog pr = new ProgressDialog(context,
        type: ProgressDialogType.Normal, isDismissible: false);
