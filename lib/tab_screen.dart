...
import 'package:my_barter/barterdetail.dart';
import 'dart:convert';
...
class _TabScreenState extends State<TabScreen> {
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Container(
                              color: Colors.deepOrange,
                              child: Center(
                                child: Text("Barter Available Today",
                                    style: TextStyle(
                                        fontSize: 16,
                                        fontWeight: FontWeight.bold,
                                        color: Colors.white)),
  ...
  Future<String> makeRequest() async {
    String urlLoadBarter =
        "https://tradebarterflutter.com/mytradebarter(user)%20/php/load_barter.php";
