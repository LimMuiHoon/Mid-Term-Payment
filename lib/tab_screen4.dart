...
import 'package:my_barter/splashscreen.dart';
...
String urluploadImage =
    "https://tradebarterflutter.com/mytradebarter(user)%20/php/upload_imageprofile.php";
String urlupdate =
    "https://tradebarterflutter.com/mytradebarter(user)%20/php/update_profile.php";
File _image;
int number = 0;
String _value;
                                    ...
                                    decoration: new BoxDecoration(
                                        ...
                                        image: new DecorationImage(
                                            ...
                                            image: new NetworkImage(
                                                "https://tradebarterflutter.com/mytradebarter(user)%20/profile/${widget.user.email}.jpg?dummy=${(number)}'")))),
                              ),
                              SizedBox(height: 50),
                              Container(
                                child: Text(
